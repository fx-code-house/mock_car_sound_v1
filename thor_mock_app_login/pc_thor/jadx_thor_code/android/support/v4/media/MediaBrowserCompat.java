...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private static String getStateLabel(int state) {
            return state != 0 ? state != 1 ? state != 2 ? state != 3 ? state != 4 ? "UNKNOWN/" + state : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
