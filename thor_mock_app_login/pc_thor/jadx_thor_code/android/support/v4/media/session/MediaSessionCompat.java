...
public class MediaSessionCompat {
    ...
    static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat state, MediaMetadataCompat metadata) {
        ...
        return new PlaybackStateCompat.Builder(state).setState(state.getState(), (j < 0 || playbackSpeed <= j) ? playbackSpeed < 0 ? 0L : playbackSpeed : j, state.getPlaybackSpeed(), jElapsedRealtime).build();
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle metadata) throws IllegalArgumentException {
