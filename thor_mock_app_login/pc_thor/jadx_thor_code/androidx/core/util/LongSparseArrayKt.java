...
public final class LongSparseArrayKt {
    ...
    public static final class C00981<T> implements Iterator<T>, KMappedMarker {
        ...
        C00981(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C00981(longSparseArray);
    }
