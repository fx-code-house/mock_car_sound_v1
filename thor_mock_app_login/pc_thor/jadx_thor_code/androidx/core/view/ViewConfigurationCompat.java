...
public final class ViewConfigurationCompat {
    ...
    public static int getScaledMinimumFlingVelocity(Context context, ViewConfiguration viewConfiguration, int i, int i2, int i3) throws Resources.NotFoundException {
    ...
    public static int getScaledMaximumFlingVelocity(Context context, ViewConfiguration viewConfiguration, int i, int i2, int i3) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 34) {
    ...
    private static int getPlatformResId(Resources resources, String str, String str2) {
        return resources.getIdentifier(str, str2, AbstractSpiCall.ANDROID_CLIENT_TYPE);
    }
