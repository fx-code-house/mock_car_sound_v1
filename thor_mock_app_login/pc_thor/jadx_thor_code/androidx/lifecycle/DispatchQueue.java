...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.mo2182dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.m83dispatchAndEnqueue$lambda2$lambda1(this.f$0, runnable);
                }
            });
        } else {
            enqueue(runnable);
    ...
    public static final void m83dispatchAndEnqueue$lambda2$lambda1(DispatchQueue this$0, Runnable runnable) {
