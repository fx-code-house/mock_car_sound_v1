...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public BrowserRoot onGetRoot(String clientPackageName, int clientUid, Bundle rootHints) {
            ...
            ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.new ConnectionRecord(clientPackageName, i, clientUid, rootHints, null);
            MediaBrowserServiceCompat.this.mCurConnection = connectionRecord;
            BrowserRoot browserRootOnGetRoot = MediaBrowserServiceCompat.this.onGetRoot(clientPackageName, clientUid, rootHints);
