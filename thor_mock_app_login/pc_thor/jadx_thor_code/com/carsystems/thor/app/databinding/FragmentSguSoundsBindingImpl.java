...
public class FragmentSguSoundsBindingImpl extends FragmentSguSoundsBinding {
    ...
    public FragmentSguSoundsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FragmentSguSoundsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.carsystems.thor.app.databinding.FragmentSguSoundsBinding
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        ...
        return onChangeModelIsInstalledSgu((ObservableBoolean) object, fieldId);
    }
    ...
    private boolean onChangeModelIsInstalledSgu(ObservableBoolean ModelIsInstalledSgu, int fieldId) {
        if (fieldId != 0) {
            return false;
        }
        synchronized (this) {
    ...
    protected void executeBindings() {
        ...
        ObservableBoolean isInstalledSgu;
        synchronized (this) {
            j = this.mDirtyFlags;
            this.mDirtyFlags = 0L;
        }
        ...
        if (j2 != 0) {
            if (mainActivityViewModel != null) {
                ...
                isInstalledSgu = mainActivityViewModel.getIsInstalledSgu();
            } else {
                isBleConnected = null;
                isInstalledSgu = null;
            }
            updateRegistration(0, isBleConnected);
            updateRegistration(1, isInstalledSgu);
            boolean z2 = isBleConnected != null ? isBleConnected.get() : false;
            z = isInstalledSgu != null ? isInstalledSgu.get() : false;
            z = z2;
        } else {
            z = false;
        }
