...
final class C2Mp3TimestampTracker {
    ...
    public long updateAndGetPresentationTimeUs(Format format, DecoderInputBuffer buffer) {
        ...
        ByteBuffer byteBuffer = (ByteBuffer) Assertions.checkNotNull(buffer.data);
        int i = 0;
        ...
        if (this.processedSamples == 0) {
            long j = buffer.timeUs;
            this.anchorTimestampUs = j;
            this.processedSamples = mpegAudioFrameSampleCount - DECODER_DELAY_SAMPLES;
            return j;
        }
