...
public abstract class DownloadService extends Service {
    ...
    public static void sendRemoveAllDownloads(Context context, Class<? extends DownloadService> clazz, boolean foreground) {
        startService(context, buildRemoveAllDownloadsIntent(context, clazz, foreground), foreground);
    }
    ...
    public static void sendSetRequirements(Context context, Class<? extends DownloadService> clazz, Requirements requirements, boolean foreground) {
        startService(context, buildSetRequirementsIntent(context, clazz, requirements, foreground), foreground);
    }
                ...
                if (requirements == null) {
                    ...
                    if (scheduler != null) {
                        ...
                        if (!supportedRequirements.equals(requirements)) {
                            Log.w(TAG, new StringBuilder(65).append("Ignoring requirements not supported by the Scheduler: ").append(requirements.getRequirements() ^ supportedRequirements.getRequirements()).toString());
    ...
    static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadService$DownloadManagerHelper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m168x5d17c8bb(downloadService);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m168x5d17c8bb(DownloadService downloadService) {
