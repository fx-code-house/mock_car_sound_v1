    ...
    private static final class Matcher {
        ...
        public void onNextFrame(long framePresentationTimeNs) {
            ...
            if (j == 0) {
                ...
                long j2 = framePresentationTimeNs - this.firstFramePresentationTimeNs;
                this.firstFrameDurationNs = j2;
                this.matchingFrameDurationSumNs = j2;
                this.matchingFrameCount = 1L;
            } else {
                long j3 = framePresentationTimeNs - this.lastFramePresentationTimeNs;
                int recentFrameOutlierIndex = getRecentFrameOutlierIndex(j);
