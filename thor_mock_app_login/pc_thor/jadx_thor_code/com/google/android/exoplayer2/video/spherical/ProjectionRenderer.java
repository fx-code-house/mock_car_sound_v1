...
final class ProjectionRenderer {
    ...
    void draw(int textureId, float[] mvpMatrix, boolean rightEye) {
        ...
        if (i == 1) {
            fArr = rightEye ? TEX_MATRIX_BOTTOM : TEX_MATRIX_TOP;
        } else if (i == 2) {
            fArr = rightEye ? TEX_MATRIX_RIGHT : TEX_MATRIX_LEFT;
        } else {
            fArr = TEX_MATRIX_WHOLE;
        }
        GLES20.glUniformMatrix3fv(this.uTexMatrixHandle, 1, false, fArr, 0);
