    ...
    final String zzh(byte[] bArr, int i, int i2) throws zzin {
        ...
        while (i < i3) {
            ...
            if (zzlf.zzd(b2)) {
                ...
                if (i6 < i3 - 1) {
                    int i8 = i6 + 1;
                    zzlf.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                    i = i8 + 1;
                    i5++;
                } else {
                    throw zzin.zzho();
                ...
                byte b4 = bArr[i6];
                int i10 = i9 + 1;
                zzlf.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                i = i10 + 1;
                i5 = i5 + 1 + 1;
            }
        }
