...
interface zzlr {
    ...
    void zza(int i, zzgs zzgsVar) throws IOException;

    <K, V> void zza(int i, zzje<K, V> zzjeVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzkc zzkcVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkc zzkcVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkc zzkcVar) throws IOException;

    void zzb(int i, List<zzgs> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkc zzkcVar) throws IOException;

    void zzb(int i, List<Integer> list, boolean z) throws IOException;

    @Deprecated
    void zzbq(int i) throws IOException;
    ...
    void zzu(int i, int i2) throws IOException;
}
