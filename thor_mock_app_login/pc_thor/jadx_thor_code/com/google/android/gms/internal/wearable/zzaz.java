...
final class zzaz extends zzbb {
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            int i3 = i + iZzw2;
            this.zzd = i3;
            int iZzd = zzel.zzd(str, this.zzb, i3, this.zzc - i3);
            this.zzd = i;
            zzl((iZzd - i) - iZzw2);
            this.zzd = iZzd;
        } catch (zzek e) {
    ...
    public final void zzn(long j) throws IOException {
        if (zzbb.zzc && this.zzc - this.zzd >= 10) {
            while ((j & (-128)) != 0) {
                byte[] bArr = this.zzb;
                int i = this.zzd;
                this.zzd = i + 1;
                zzeg.zzp(bArr, i, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr2 = this.zzb;
            int i2 = this.zzd;
            this.zzd = i2 + 1;
            zzeg.zzp(bArr2, i2, (byte) j);
            return;
        }
        while ((j & (-128)) != 0) {
            try {
