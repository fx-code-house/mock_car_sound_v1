...
public abstract class zzbb extends zzal {
    ...
    static int zzB(zzcx zzcxVar, zzdi zzdiVar) {
        ...
        return zzw(iZzJ) + iZzJ;
    }

    @Deprecated
    static int zzE(int i, zzcx zzcxVar, zzdi zzdiVar) {
        int iZzw = zzw(i << 3);
        int i2 = iZzw + iZzw;
        zzaf zzafVar = (zzaf) zzcxVar;
        int iZzJ = zzafVar.zzJ();
    ...
    final void zzD(String str, zzek zzekVar) throws IOException {
