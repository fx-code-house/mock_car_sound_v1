...
public class ConnectionConfiguration extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    ConnectionConfiguration(String str, String str2, int i, int i2, boolean z, boolean z2, String str3, boolean z3, String str4, String str5) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = i;
        this.zzd = i2;
    ...
    public final String toString() {
        ...
        String strValueOf5 = String.valueOf(this.zzj);
