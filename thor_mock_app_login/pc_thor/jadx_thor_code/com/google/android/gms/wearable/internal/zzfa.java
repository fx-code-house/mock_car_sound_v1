...
final class zzfa extends zzn<Status> {
    ...
    /* synthetic */ zzfa(GoogleApiClient googleApiClient, MessageApi.MessageListener messageListener, ListenerHolder listenerHolder, IntentFilter[] intentFilterArr, zzey zzeyVar) {
    ...
    protected final /* bridge */ /* synthetic */ void doExecute(Api.AnyClient anyClient) throws RemoteException {
        ((zzhv) anyClient).zzu(this, this.zza, this.zzb, this.zzc);
        this.zza = null;
        this.zzb = null;
        this.zzc = null;
    }
