...
public final class zzfv extends NodeClient {
    ...
    public final Task<List<Node>> getConnectedNodes() {
        ...
        return PendingResultUtil.toTask(googleApiClientAsGoogleApiClient.enqueue(new zzfm((zzfp) nodeApi, googleApiClientAsGoogleApiClient)), zzfr.zza);
    }
    ...
    public final Task<Node> getLocalNode() {
        NodeApi nodeApi = this.zza;
        GoogleApiClient googleApiClientAsGoogleApiClient = asGoogleApiClient();
        return PendingResultUtil.toTask(googleApiClientAsGoogleApiClient.enqueue(new zzfl((zzfp) nodeApi, googleApiClientAsGoogleApiClient)), zzfq.zza);
    }
