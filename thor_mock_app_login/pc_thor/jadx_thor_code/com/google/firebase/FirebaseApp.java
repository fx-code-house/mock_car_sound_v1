...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        listDiscover.add(new FirebaseCommonRegistrar());
        this.componentRuntime = new ComponentRuntime(UI_EXECUTOR, listDiscover, Component.of(context, Context.class, new Class[0]), Component.of(this, FirebaseApp.class, new Class[0]), Component.of(firebaseOptions, FirebaseOptions.class, new Class[0]));
