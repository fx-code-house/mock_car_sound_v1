...
public class CrashlyticsCore {
    ...
    public boolean onPreExecute(SettingsDataProvider settingsDataProvider) {
        ...
        try {
            ...
            AppData appDataCreate = AppData.create(this.context, this.idManager, applicationId, mappingFileId, new ResourceUnityVersionProvider(this.context));
            Logger.getLogger().d("Installer package name is: " + appDataCreate.installerPackageName);
            this.controller = new CrashlyticsController(this.context, this.backgroundWorker, httpRequestFactory, this.idManager, this.dataCollectionArbiter, fileStoreImpl, this.crashMarker, appDataCreate, null, null, this.nativeComponent, this.analyticsEventLogger, settingsDataProvider);
        ...
        this.backgroundWorker.submit(new Callable<Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore.3
            ...
            public Boolean call() throws Exception {
                try {
                    ...
                    Logger.getLogger().d("Initialization marker file removed: " + zRemove);
