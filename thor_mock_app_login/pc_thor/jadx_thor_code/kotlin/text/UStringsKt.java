...
public final class UStringsKt {
    ...
    public static final String m1937toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1939toStringolVBNx4(short s, int i) {
    ...
    public static final String m1938toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1936toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m719constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m636boximpl(UByte.m642constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m719constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m899boximpl(UShort.m905constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM719constructorimpl = UInt.m719constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM719constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM719constructorimpl2 = UInt.m719constructorimpl(i3 * iM719constructorimpl);
            int iM719constructorimpl3 = UInt.m719constructorimpl(UInt.m719constructorimpl(iDigitOf) + iM719constructorimpl2);
            if (Integer.compareUnsigned(iM719constructorimpl3, iM719constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM719constructorimpl3;
        }
        return UInt.m713boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM798constructorimpl = ULong.m798constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM798constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM798constructorimpl2 = ULong.m798constructorimpl(j * jM798constructorimpl);
            long jM798constructorimpl3 = ULong.m798constructorimpl(ULong.m798constructorimpl(UInt.m719constructorimpl(r13) & 4294967295L) + jM798constructorimpl2);
            if (Long.compareUnsigned(jM798constructorimpl3, jM798constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM798constructorimpl3;
        }
        return ULong.m792boximpl(j);
    }
}
