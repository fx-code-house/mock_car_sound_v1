...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1941minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2087minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1940elapsedNowUwyO8pc() {
        return Duration.m1985minusLRDsOJo(this.mark.mo1940elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1943plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1986plusLRDsOJo(this.adjustment, duration), null);
    }
}
