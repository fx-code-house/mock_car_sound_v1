...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM624constructorimpl = Result.m624constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM624constructorimpl = Result.m624constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2137boximpl(Result.m631isSuccessimpl(objM624constructorimpl) ? ChannelResult.INSTANCE.m2152successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2150closedJP2dKIU(Result.m627exceptionOrNullimpl(objM624constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2127trySendJP2dKIU = sendChannel.mo2127trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2147isSuccessimpl(sendChannel.mo2127trySendJP2dKIU(obj))) {
            return;
        }
