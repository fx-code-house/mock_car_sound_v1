...
public interface SendChannel<E> {
    ...
    void mo2194invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo2127trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2147isSuccessimpl(objMo2127trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2141exceptionOrNullimpl = ChannelResult.m2141exceptionOrNullimpl(objMo2127trySendJP2dKIU);
