...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, task, (Object) null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == onlyBlocking && LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, i, task, (Object) null)) {
                if (onlyBlocking) {
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        } while (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, (Object) r1, (Object) null));
