    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L1c:
            ...
            boolean r6 = r1.getCanceled()     // Catch: java.lang.Throwable -> Lea
            if (r6 != 0) goto Le0
        ...
        L43:
            r7 = r0
            okhttp3.internal.connection.Exchange r0 = r1.getInterceptorScopedExchange()     // Catch: java.lang.Throwable -> Lea
            okhttp3.Request r6 = r10.followUpRequest(r7, r0)     // Catch: java.lang.Throwable -> Lea
            if (r6 != 0) goto L5d
            if (r0 == 0) goto L59
            boolean r11 = r0.getIsDuplex()     // Catch: java.lang.Throwable -> Lea
            if (r11 == 0) goto L59
