...
public class FieldUtils {
    ...
    public static void writeStaticField(Field field, Object obj, boolean z) throws IllegalAccessException, IllegalArgumentException {
        Validate.notNull(field, "field", new Object[0]);
    ...
    public static void writeStaticField(Class<?> cls, String str, Object obj, boolean z) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Field field = getField(cls, str, z);
        Validate.notNull(field, "Cannot locate field %s on %s", str, cls);
        writeStaticField(field, obj, false);
    }

    public static void writeDeclaredStaticField(Class<?> cls, String str, Object obj) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        writeDeclaredStaticField(cls, str, obj, false);
    }

    public static void writeDeclaredStaticField(Class<?> cls, String str, Object obj, boolean z) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Field declaredField = getDeclaredField(cls, str, z);
        Validate.notNull(declaredField, "Cannot locate declared field %s.%s", cls.getName(), str);
    ...
    public static void writeField(Field field, Object obj, Object obj2, boolean z) throws IllegalAccessException, IllegalArgumentException {
        Validate.notNull(field, "field", new Object[0]);
        if (z && !field.isAccessible()) {
            field.setAccessible(true);
        } else {
    ...
    public static void writeField(Object obj, String str, Object obj2, boolean z) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Validate.notNull(obj, "target", new Object[0]);
        Class<?> cls = obj.getClass();
        Field field = getField(cls, str, z);
    ...
    public static void writeDeclaredField(Object obj, String str, Object obj2) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        writeDeclaredField(obj, str, obj2, false);
    }

    public static void writeDeclaredField(Object obj, String str, Object obj2, boolean z) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Validate.notNull(obj, "target", new Object[0]);
        Class<?> cls = obj.getClass();
        Field declaredField = getDeclaredField(cls, str, z);
