...
public class DecoratedWithGem implements Gem {
    ...
    public interface Builder<T> {
        ...
        Builder setValue(GemValue<TypeMirror> gemValue);
    }

    private DecoratedWithGem(BuilderImpl builderImpl) {
        GemValue<TypeMirror> gemValue = builderImpl.value;
        this.value = gemValue;
    ...
    public static DecoratedWithGem instanceOn(Element element) {
        return (DecoratedWithGem) build(element, new BuilderImpl());
    }

    public static DecoratedWithGem instanceOn(AnnotationMirror annotationMirror) {
        return (DecoratedWithGem) build(annotationMirror, new BuilderImpl());
    }

    public static <T> T build(Element element, Builder<T> builder) {
        return (T) build((AnnotationMirror) element.getAnnotationMirrors().stream().filter(new Predicate() { // from class: org.mapstruct.ap.internal.gem.DecoratedWithGem$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return "org.mapstruct.DecoratedWith".contentEquals((CharSequence) ((AnnotationMirror) obj).getAnnotationType().asElement().getQualifiedName());
            }
    ...
    public static <T> T build(AnnotationMirror annotationMirror, Builder<T> builder) {
        ...
        listMethodsIn.forEach(new Consumer() { // from class: org.mapstruct.ap.internal.gem.DecoratedWithGem$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DecoratedWithGem.lambda$build$1(map, (ExecutableElement) obj);
            }
        });
        final HashMap map2 = new HashMap(listMethodsIn.size());
        annotationMirror.getElementValues().entrySet().forEach(new Consumer() { // from class: org.mapstruct.ap.internal.gem.DecoratedWithGem$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                DecoratedWithGem.lambda$build$2(map2, (Map.Entry) obj);
            }
        });
        for (String str : map.keySet()) {
            if ("value".equals(str)) {
                builder.setValue(GemValue.create((AnnotationValue) map2.get(str), (AnnotationValue) map.get(str), TypeMirror.class));
            }
        }
    ...
    private static class BuilderImpl implements Builder<DecoratedWithGem> {
        ...
        @Override // org.mapstruct.ap.internal.gem.DecoratedWithGem.Builder
        public Builder setValue(GemValue<TypeMirror> gemValue) {
            this.value = gemValue;
            return this;
        }
