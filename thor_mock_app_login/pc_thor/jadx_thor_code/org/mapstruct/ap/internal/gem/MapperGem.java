...
public class MapperGem implements Gem {
    ...
    private MapperGem(BuilderImpl builderImpl) {
        ...
        GemValue<TypeMirror> gemValue9 = builderImpl.config;
        this.config = gemValue9;
        GemValue<String> gemValue10 = builderImpl.collectionMappingStrategy;
        this.collectionMappingStrategy = gemValue10;
        GemValue<String> gemValue11 = builderImpl.nullValueMappingStrategy;
        this.nullValueMappingStrategy = gemValue11;
        GemValue<String> gemValue12 = builderImpl.nullValuePropertyMappingStrategy;
        this.nullValuePropertyMappingStrategy = gemValue12;
        GemValue<String> gemValue13 = builderImpl.mappingInheritanceStrategy;
        this.mappingInheritanceStrategy = gemValue13;
        GemValue<String> gemValue14 = builderImpl.nullValueCheckStrategy;
        this.nullValueCheckStrategy = gemValue14;
        GemValue<String> gemValue15 = builderImpl.injectionStrategy;
        this.injectionStrategy = gemValue15;
        GemValue<Boolean> gemValue16 = builderImpl.disableSubMappingMethodsGeneration;
        this.disableSubMappingMethodsGeneration = gemValue16;
        GemValue<BuilderGem> gemValue17 = builderImpl.builder;
        this.builder = gemValue17;
        GemValue<TypeMirror> gemValue18 = builderImpl.mappingControl;
        this.mappingControl = gemValue18;
        GemValue<TypeMirror> gemValue19 = builderImpl.unexpectedValueMappingException;
        this.unexpectedValueMappingException = gemValue19;
        this.isValid = gemValue != null && gemValue.isValid() && gemValue2 != null && gemValue2.isValid() && gemValue3 != null && gemValue3.isValid() && gemValue4 != null && gemValue4.isValid() && gemValue5 != null && gemValue5.isValid() && gemValue6 != null && gemValue6.isValid() && gemValue7 != null && gemValue7.isValid() && gemValue8 != null && gemValue8.isValid() && gemValue9 != null && gemValue9.isValid() && gemValue10 != null && gemValue10.isValid() && gemValue11 != null && gemValue11.isValid() && gemValue12 != null && gemValue12.isValid() && gemValue13 != null && gemValue13.isValid() && gemValue14 != null && gemValue14.isValid() && gemValue15 != null && gemValue15.isValid() && gemValue16 != null && gemValue16.isValid() && gemValue17 != null && gemValue17.isValid() && gemValue18 != null && gemValue18.isValid() && gemValue19 != null && gemValue19.isValid();
    ...
    public static <T> T build(Element element, Builder<T> builder) {
        return (T) build((AnnotationMirror) element.getAnnotationMirrors().stream().filter(new Predicate() { // from class: org.mapstruct.ap.internal.gem.MapperGem$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return "org.mapstruct.Mapper".contentEquals((CharSequence) ((AnnotationMirror) obj).getAnnotationType().asElement().getQualifiedName());
            }
    ...
    public static <T> T build(AnnotationMirror annotationMirror, Builder<T> builder) {
        ...
        listMethodsIn.forEach(new Consumer() { // from class: org.mapstruct.ap.internal.gem.MapperGem$$ExternalSyntheticLambda0
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                MapperGem.lambda$build$1(map, (ExecutableElement) obj);
            }
        });
        final HashMap map2 = new HashMap(listMethodsIn.size());
        annotationMirror.getElementValues().entrySet().forEach(new Consumer() { // from class: org.mapstruct.ap.internal.gem.MapperGem$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                MapperGem.lambda$build$2(map2, (Map.Entry) obj);
            }
        });
        for (String str : map.keySet()) {
            if ("uses".equals(str)) {
                ...
                builder.setConfig(GemValue.create((AnnotationValue) map2.get(str), (AnnotationValue) map.get(str), TypeMirror.class));
