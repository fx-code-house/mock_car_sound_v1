...
public enum Message {
    ...
    GENERAL_AMBIGUOUS_MAPPING_METHOD("Ambiguous mapping methods found for mapping %s to %s: %s. See https://mapstruct.org/faq/#ambiguous for more info."),
    GENERAL_AMBIGUOUS_FACTORY_METHOD("Ambiguous factory methods found for creating %s: %s. See https://mapstruct.org/faq/#ambiguous for more info."),
    ...
    GENERAL_NO_QUALIFYING_METHOD_ANNOTATION("Qualifier error. No method found annotated with: [ %s ]. See https://mapstruct.org/faq/#qualifier for more info."),
    GENERAL_NO_QUALIFYING_METHOD_NAMED("Qualifier error. No method found annotated with @Named#value: [ %s ]. See https://mapstruct.org/faq/#qualifier for more info."),
    GENERAL_NO_QUALIFYING_METHOD_COMBINED("Qualifier error. No method found annotated with @Named#value: [ %s ], annotated with [ %s ]. See https://mapstruct.org/faq/#qualifier for more info."),
    ...
    Message(String str, Diagnostic.Kind kind) {
        this.description = str;
        this.kind = kind;
    }
