...
public final class NavDeepLinkBuilder {
    ...
    public TaskStackBuilder createTaskStackBuilder() {
        ...
        for (int i = 0; i < taskStackBuilderAddNextIntentWithParentStack.getIntentCount(); i++) {
            taskStackBuilderAddNextIntentWithParentStack.editIntentAt(i).putExtra(NavController.KEY_DEEP_LINK_INTENT, this.mIntent);
        }
    ...
    public PendingIntent createPendingIntent() {
        ...
        return createTaskStackBuilder().getPendingIntent((i * 31) + this.mDestId, BleCommands.SETTINGS_DAT_FILE_ID);
    }
