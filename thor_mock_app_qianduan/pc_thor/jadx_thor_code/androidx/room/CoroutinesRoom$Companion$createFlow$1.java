            ...
            if (i == 0) {
                ...
                ?? r7 = new InvalidationTracker.Observer(strArr) { // from class: androidx.room.CoroutinesRoom$Companion$createFlow$1$1$observer$1
                    ...
                    public void onInvalidated(Set<String> tables) {
                        ...
                        channelChannel$default.mo2127trySendJP2dKIU(Unit.INSTANCE);
                    }
                };
                channelChannel$default.mo2127trySendJP2dKIU(Unit.INSTANCE);
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, transactionDispatcher, null, new C00071(this.$db, r7, channelChannel$default, this.$callable, channelChannel$default2, null), 2, null);
                this.label = 1;
