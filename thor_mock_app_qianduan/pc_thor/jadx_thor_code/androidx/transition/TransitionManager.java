...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo97clone = transition.mo97clone();
        transitionMo97clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo97clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo97clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo97clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo97clone = transition.mo97clone();
        sceneChangeSetup(viewGroup, transitionMo97clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo97clone);
    }
