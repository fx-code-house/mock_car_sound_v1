...
public class TransitionSet extends Transition {
    ...
    String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            string = string + StringUtils.LF + this.mTransitions.get(i).toString(str + "  ");
        }
        return string;
    }
    ...
    public Transition mo97clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo97clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo97clone());
        }
