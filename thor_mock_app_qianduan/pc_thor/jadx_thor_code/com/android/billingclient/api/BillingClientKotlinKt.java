    ...
    public static final Object acknowledgePurchase(BillingClient billingClient, AcknowledgePurchaseParams acknowledgePurchaseParams, Continuation<? super BillingResult> continuation) {
        ...
        billingClient.acknowledgePurchase(acknowledgePurchaseParams, new AcknowledgePurchaseResponseListener() { // from class: com.android.billingclient.api.BillingClientKotlinKt.acknowledgePurchase.2
            ...
            public final void onAcknowledgePurchaseResponse(BillingResult it) {
                CompletableDeferred<BillingResult> completableDeferred = completableDeferredCompletableDeferred$default;
    ...
    public static final Object consumePurchase(BillingClient billingClient, ConsumeParams consumeParams, Continuation<? super ConsumeResult> continuation) {
        ...
        billingClient.consumeAsync(consumeParams, new ConsumeResponseListener() { // from class: com.android.billingclient.api.BillingClientKotlinKt.consumePurchase.2
            ...
            public final void onConsumeResponse(BillingResult billingResult, String str) {
                ...
                completableDeferredCompletableDeferred$default.complete(new ConsumeResult(billingResult, str));
            }
        });
        return completableDeferredCompletableDeferred$default.await(continuation);
    }
    ...
    public static final Object queryProductDetails(BillingClient billingClient, QueryProductDetailsParams queryProductDetailsParams, Continuation<? super ProductDetailsResult> continuation) {
        ...
        billingClient.queryProductDetailsAsync(queryProductDetailsParams, new ProductDetailsResponseListener() { // from class: com.android.billingclient.api.BillingClientKotlinKt.queryProductDetails.2
            ...
            public final void onProductDetailsResponse(BillingResult billingResult, List<ProductDetails> list) {
                Intrinsics.checkNotNullExpressionValue(billingResult, "billingResult");
                completableDeferredCompletableDeferred$default.complete(new ProductDetailsResult(billingResult, list));
            }
        });
        return completableDeferredCompletableDeferred$default.await(continuation);
    }
    ...
    public static final Object queryPurchaseHistory(BillingClient billingClient, QueryPurchaseHistoryParams queryPurchaseHistoryParams, Continuation<? super PurchaseHistoryResult> continuation) {
        ...
        billingClient.queryPurchaseHistoryAsync(queryPurchaseHistoryParams, new PurchaseHistoryResponseListener() { // from class: com.android.billingclient.api.BillingClientKotlinKt.queryPurchaseHistory.4
            ...
            public final void onPurchaseHistoryResponse(BillingResult billingResult, List<PurchaseHistoryRecord> list) {
                Intrinsics.checkNotNullExpressionValue(billingResult, "billingResult");
                completableDeferredCompletableDeferred$default.complete(new PurchaseHistoryResult(billingResult, list));
            }
        });
        return completableDeferredCompletableDeferred$default.await(continuation);
    }
    ...
    public static final Object queryPurchasesAsync(BillingClient billingClient, QueryPurchasesParams queryPurchasesParams, Continuation<? super PurchasesResult> continuation) {
        ...
        billingClient.queryPurchasesAsync(queryPurchasesParams, new PurchasesResponseListener() { // from class: com.android.billingclient.api.BillingClientKotlinKt.queryPurchasesAsync.4
            ...
            public final void onQueryPurchasesResponse(BillingResult billingResult, List<Purchase> purchases) {
                ...
                completableDeferredCompletableDeferred$default.complete(new PurchasesResult(billingResult, purchases));
            }
        });
        return completableDeferredCompletableDeferred$default.await(continuation);
    }
    ...
    public static final Object querySkuDetails(BillingClient billingClient, SkuDetailsParams skuDetailsParams, Continuation<? super SkuDetailsResult> continuation) {
        ...
        billingClient.querySkuDetailsAsync(skuDetailsParams, new SkuDetailsResponseListener() { // from class: com.android.billingclient.api.BillingClientKotlinKt.querySkuDetails.2
            ...
            public final void onSkuDetailsResponse(BillingResult billingResult, List<SkuDetails> list) {
                Intrinsics.checkNotNullExpressionValue(billingResult, "billingResult");
                completableDeferredCompletableDeferred$default.complete(new SkuDetailsResult(billingResult, list));
            }
        });
        return completableDeferredCompletableDeferred$default.await(continuation);
    }
