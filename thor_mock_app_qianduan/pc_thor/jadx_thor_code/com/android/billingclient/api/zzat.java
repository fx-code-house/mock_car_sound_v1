...
final class zzat {
    ...
    static {
        ...
        builderNewBuilder24.setDebugMessage("Client does not support alternative billing.");
        zzx = builderNewBuilder24.build();
        BillingResult.Builder builderNewBuilder25 = BillingResult.newBuilder();
        builderNewBuilder25.setResponseCode(5);
        builderNewBuilder25.setDebugMessage("Unknown feature");
        ...
        builderNewBuilder26.setDebugMessage("Play Store version installed does not support get billing config.");
        ...
        builderNewBuilder27.setDebugMessage("Query product details with serialized docid is not supported.");
        zzA = builderNewBuilder27.build();
        BillingResult.Builder builderNewBuilder28 = BillingResult.newBuilder();
        builderNewBuilder28.setResponseCode(4);
        builderNewBuilder28.setDebugMessage("Item is unavailable for purchase.");
        ...
        builderNewBuilder29.setDebugMessage("Query product details with developer specified account is not supported.");
