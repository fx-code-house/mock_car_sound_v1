...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public void setStopReason(int stopReason) throws DatabaseIOException {
        ...
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put("stop_reason", Integer.valueOf(stopReason));
    ...
    public void setStopReason(String id, int stopReason) throws DatabaseIOException {
        ...
        try {
            ...
            writableDatabase.update(str, contentValues, new StringBuilder(String.valueOf(str2).length() + 11).append(str2).append(" AND id = ?").toString(), new String[]{id});
        } catch (SQLException e) {
            throw new DatabaseIOException(e);
        }
    }
            ...
            try {
                ...
                if (version != 3) {
                    ...
                    try {
                        ...
                        String str = this.tableName;
                        writableDatabase.execSQL(new StringBuilder(String.valueOf(str).length() + 415).append("CREATE TABLE ").append(str).append(" (id TEXT PRIMARY KEY NOT NULL,mime_type TEXT,uri TEXT NOT NULL,stream_keys TEXT NOT NULL,custom_cache_key TEXT,data BLOB NOT NULL,state INTEGER NOT NULL,start_time_ms INTEGER NOT NULL,update_time_ms INTEGER NOT NULL,content_length INTEGER NOT NULL,stop_reason INTEGER NOT NULL,failure_reason INTEGER NOT NULL,percent_downloaded REAL NOT NULL,bytes_downloaded INTEGER NOT NULL,key_set_id BLOB NOT NULL)").toString());
    ...
    private void putDownloadInternal(Download download, SQLiteDatabase database) throws SQLException {
        ...
        database.replaceOrThrow(this.tableName, null, contentValues);
    }
    ...
    private static String inferMimeType(String downloadType) {
        return "dash".equals(downloadType) ? MimeTypes.APPLICATION_MPD : "hls".equals(downloadType) ? MimeTypes.APPLICATION_M3U8 : "ss".equals(downloadType) ? MimeTypes.APPLICATION_SS : MimeTypes.VIDEO_UNKNOWN;
    }
    ...
    private static List<StreamKey> decodeStreamKeys(String encodedStreamKeys) {
        ...
        for (String str : Util.split(encodedStreamKeys, ",")) {
