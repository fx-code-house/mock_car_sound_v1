...
public final class PlatformScheduler implements Scheduler {
    ...
    public boolean schedule(Requirements requirements, String servicePackage, String serviceAction) {
        return this.jobScheduler.schedule(buildJobInfo(this.jobId, this.jobServiceComponentName, requirements, serviceAction, servicePackage)) == 1;
    }
    ...
    private static JobInfo buildJobInfo(int jobId, ComponentName jobServiceComponentName, Requirements requirements, String serviceAction, String servicePackage) {
        ...
        persistableBundle.putString(KEY_SERVICE_ACTION, serviceAction);
        persistableBundle.putString(KEY_SERVICE_PACKAGE, servicePackage);
