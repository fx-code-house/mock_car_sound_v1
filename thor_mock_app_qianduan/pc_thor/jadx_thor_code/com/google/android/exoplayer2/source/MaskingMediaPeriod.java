...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public void createPeriod(MediaSource.MediaPeriodId id) {
        ...
        MediaPeriod mediaPeriodCreatePeriod = ((MediaSource) Assertions.checkNotNull(this.mediaSource)).createPeriod(id, this.allocator, preparePositionWithOverride);
    ...
    public long selectTracks(ExoTrackSelection[] selections, boolean[] mayRetainStreamFlags, SampleStream[] streams, boolean[] streamResetFlags, long positionUs) {
        ...
        if (j2 == C.TIME_UNSET || positionUs != this.preparePositionUs) {
            j = positionUs;
        } else {
