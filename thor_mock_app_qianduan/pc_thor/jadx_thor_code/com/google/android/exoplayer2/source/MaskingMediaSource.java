...
public final class MaskingMediaSource extends CompositeMediaSource<Void> {
    ...
    */
    public void m172x365769cd(java.lang.Void r13, com.google.android.exoplayer2.source.MediaSource r14, com.google.android.exoplayer2.Timeline r15) {
        /*
            r12 = this;
        ...
        Lc8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.source.MaskingMediaSource.m172x365769cd(java.lang.Void, com.google.android.exoplayer2.source.MediaSource, com.google.android.exoplayer2.Timeline):void");
    }
    ...
    private Object getInternalPeriodUid(Object externalPeriodUid) {
        return (this.timeline.replacedInternalPeriodUid == null || !externalPeriodUid.equals(MaskingTimeline.MASKING_EXTERNAL_PERIOD_UID)) ? externalPeriodUid : this.timeline.replacedInternalPeriodUid;
    }

    private Object getExternalPeriodUid(Object internalPeriodUid) {
        return (this.timeline.replacedInternalPeriodUid == null || !this.timeline.replacedInternalPeriodUid.equals(internalPeriodUid)) ? internalPeriodUid : MaskingTimeline.MASKING_EXTERNAL_PERIOD_UID;
    }
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long preparePositionOverrideUs) {
        ...
        long j = this.timeline.getPeriod(indexOfPeriod, this.period).durationUs;
        if (j != C.TIME_UNSET && preparePositionOverrideUs >= j) {
    ...
    private static final class MaskingTimeline extends ForwardingTimeline {
        ...
        public int getIndexOfPeriod(Object uid) {
            ...
            if (MASKING_EXTERNAL_PERIOD_UID.equals(uid) && (obj = this.replacedInternalPeriodUid) != null) {
                uid = obj;
            }
