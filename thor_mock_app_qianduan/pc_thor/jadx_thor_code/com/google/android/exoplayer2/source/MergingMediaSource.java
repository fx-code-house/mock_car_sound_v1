...
public final class MergingMediaSource extends CompositeMediaSource<Integer> {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId id, Allocator allocator, long startPositionUs) {
        ...
        ClippingMediaPeriod clippingMediaPeriod = new ClippingMediaPeriod(mergingMediaPeriod, true, 0L, ((Long) Assertions.checkNotNull(this.clippedDurationsUs.get(id.periodUid))).longValue());
        this.clippedMediaPeriods.put(id.periodUid, clippingMediaPeriod);
    ...
    public void m172x365769cd(Integer id, MediaSource mediaSource, Timeline timeline) {
    ...
    private static final class ClippedTimeline extends ForwardingTimeline {
        ...
        public ClippedTimeline(Timeline timeline, Map<Object, Long> clippedDurationsUs) {
            ...
            for (int i2 = 0; i2 < periodCount; i2++) {
                ...
                long jLongValue = ((Long) Assertions.checkNotNull(clippedDurationsUs.get(period.uid))).longValue();
