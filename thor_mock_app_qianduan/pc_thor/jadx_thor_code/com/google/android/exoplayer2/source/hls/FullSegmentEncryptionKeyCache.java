...
final class FullSegmentEncryptionKeyCache {
    ...
    public FullSegmentEncryptionKeyCache(final int maxSize) {
        this.backingMap = new LinkedHashMap<Uri, byte[]>(this, maxSize + 1, 1.0f, false) { // from class: com.google.android.exoplayer2.source.hls.FullSegmentEncryptionKeyCache.1
