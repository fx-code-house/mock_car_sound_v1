...
interface zzhg {
    ...
    void zza(int i, zzct zzctVar) throws IOException;

    <K, V> void zza(int i, zzey<K, V> zzeyVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzfu zzfuVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzfu zzfuVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzfu zzfuVar) throws IOException;

    void zzb(int i, List<zzct> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzfu zzfuVar) throws IOException;
