...
public enum zzhs {
    ...
    zzhs(int i, zzhu zzhuVar, zzil zzilVar) {
        ...
        this.zzbd = (zzhuVar != zzhu.SCALAR || (i2 = zzhv.zzb[zzilVar.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : true;
    }
    ...
    static {
        zzhs[] zzhsVarArrValues = values();
        zzbe = new zzhs[zzhsVarArrValues.length];
        for (zzhs zzhsVar : zzhsVarArrValues) {
