...
public final class zzb {
    ...
    public static BillingResult zzd(Intent intent, String str) {
        if (intent != null) {
            ...
            builderNewBuilder.setDebugMessage(zzf(intent.getExtras(), str));
    ...
    public static List zzh(Bundle bundle) {
        ...
        if (stringArrayList == null || stringArrayList2 == null) {
            ...
            for (int i = 0; i < stringArrayList.size() && i < stringArrayList2.size(); i++) {
                Purchase purchaseZzm2 = zzm(stringArrayList.get(i), stringArrayList2.get(i));
    ...
    public static void zzi(String str, String str2) {
        if (Log.isLoggable(str, 2)) {
            ...
            while (!str2.isEmpty() && i > 0) {
                int iMin = Math.min(str2.length(), Math.min(WearableStatusCodes.TARGET_NODE_NOT_CONNECTED, i));
