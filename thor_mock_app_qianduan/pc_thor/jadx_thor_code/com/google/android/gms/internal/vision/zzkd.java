...
interface zzkd {
    ...
    <T> T zza(zzkc<T> zzkcVar, zzho zzhoVar) throws IOException;

    <T> T zza(Class<T> cls, zzho zzhoVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkc<T> zzkcVar, zzho zzhoVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzje<K, V> zzjeVar, zzho zzhoVar) throws IOException;

    @Deprecated
    <T> T zzb(Class<T> cls, zzho zzhoVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkc<T> zzkcVar, zzho zzhoVar) throws IOException;

    @Deprecated
    <T> T zzc(zzkc<T> zzkcVar, zzho zzhoVar) throws IOException;
