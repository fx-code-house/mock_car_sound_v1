...
public final class zzcg extends zzag<String> implements RandomAccess, zzch {
    ...
    private static String zzj(Object obj) {
        return obj instanceof String ? (String) obj : obj instanceof zzau ? ((zzau) obj).zzo(zzca.zza) : zzca.zzd((byte[]) obj);
    }
    ...
    public final String get(int i) {
        ...
        if (obj instanceof zzau) {
            ...
            String strZzo = zzauVar.zzo(zzca.zza);
            if (zzauVar.zzi()) {
