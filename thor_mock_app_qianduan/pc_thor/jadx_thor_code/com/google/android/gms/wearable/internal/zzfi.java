...
public final class zzfi extends MessageClient {
    ...
    private final Task<Void> zza(final MessageClient.OnMessageReceivedListener onMessageReceivedListener, final IntentFilter[] intentFilterArr) {
        ...
        return doRegisterEventListener(RegistrationMethods.builder().withHolder(listenerHolderCreateListenerHolder).register(new RemoteCall(onMessageReceivedListener, listenerHolderCreateListenerHolder, intentFilterArr) { // from class: com.google.android.gms.wearable.internal.zzff
    ...
    public final Task<Integer> sendMessage(String str, String str2, byte[] bArr) {
        ...
        return PendingResultUtil.toTask(googleApiClientAsGoogleApiClient.enqueue(new zzey(zzfcVar, googleApiClientAsGoogleApiClient, str, str2, bArr)), zzfd.zza);
    }
