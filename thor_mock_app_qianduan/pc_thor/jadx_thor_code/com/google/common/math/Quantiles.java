        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                if (i < iArr6.length) {
                    ...
                    int i6 = iArr4[i];
                    if (i6 == 0) {
                        map2.put(Integer.valueOf(iArr6[i]), Double.valueOf(dArr[i5]));
                    } else {
                        map2.put(Integer.valueOf(iArr6[i]), Double.valueOf(Quantiles.interpolate(dArr[i5], dArr[i5 + 1], i6, this.scale)));
                    }
                    i++;
                } else {
