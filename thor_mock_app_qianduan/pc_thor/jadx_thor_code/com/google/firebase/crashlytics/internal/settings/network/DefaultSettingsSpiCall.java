...
public class DefaultSettingsSpiCall extends AbstractSpiCall implements SettingsSpiCall {
    ...
    public JSONObject invoke(SettingsRequest settingsRequest, boolean z) {
        ...
        try {
            ...
            HttpRequest httpRequestApplyHeadersTo = applyHeadersTo(getHttpRequest(queryParamsFor), settingsRequest);
            this.logger.d("Requesting settings from " + getUrl());
            this.logger.d("Settings query params were: " + queryParamsFor);
            HttpResponse httpResponseExecute = httpRequestApplyHeadersTo.execute();
            this.logger.d("Settings request ID: " + httpResponseExecute.header(AbstractSpiCall.HEADER_REQUEST_ID));
            return handleResponse(httpResponseExecute);
        } catch (IOException e) {
    ...
    JSONObject handleResponse(HttpResponse httpResponse) {
        ...
        this.logger.d("Settings result was: " + iCode);
