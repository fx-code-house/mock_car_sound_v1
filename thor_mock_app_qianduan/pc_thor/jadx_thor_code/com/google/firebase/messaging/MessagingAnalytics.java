...
public class MessagingAnalytics {
    ...
    static void logToScion(String str, Intent intent) {
        ...
        if (Log.isLoggable(Constants.TAG, 3)) {
            ...
            Log.d(Constants.TAG, new StringBuilder(String.valueOf(str).length() + 37 + String.valueOf(strValueOf).length()).append("Logging to scion event=").append(str).append(" scionPayload=").append(strValueOf).toString());
        }
        AnalyticsConnector analyticsConnector = (AnalyticsConnector) FirebaseApp.getInstance().get(AnalyticsConnector.class);
        if (analyticsConnector != null) {
    ...
    static int getTtl(Intent intent) {
        ...
        try {
            ...
            Log.w(Constants.TAG, new StringBuilder(String.valueOf(strValueOf).length() + 13).append("Invalid TTL: ").append(strValueOf).toString());
            return 0;
        }
    }
