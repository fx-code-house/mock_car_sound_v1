...
public final class LongSaturatedMathKt {
    ...
    public static final long m2079saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM1996toLongimpl = Duration.m1996toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2078checkInfiniteSumDefinedPjuGub4(j, j2, jM1996toLongimpl);
        }
        if ((1 | (jM1996toLongimpl - 1)) == Long.MAX_VALUE) {
            return m2080saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
    ...
    private static final long m2078checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
    ...
    private static final long m2080saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM1953divUwyO8pc = Duration.m1953divUwyO8pc(j2, 2);
        long jM1996toLongimpl = Duration.m1996toLongimpl(jM1953divUwyO8pc, durationUnit);
        return ((1 | (jM1996toLongimpl - 1)) > Long.MAX_VALUE ? 1 : ((1 | (jM1996toLongimpl - 1)) == Long.MAX_VALUE ? 0 : -1)) == 0 ? jM1996toLongimpl : m2079saturatingAddNuflL3o(m2079saturatingAddNuflL3o(j, durationUnit, jM1953divUwyO8pc), durationUnit, Duration.m1985minusLRDsOJo(j2, jM1953divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m2052getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m2051getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2003unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            ...
            return Duration.m2003unaryMinusUwyO8pc(infinityOfSign(j3));
        }
