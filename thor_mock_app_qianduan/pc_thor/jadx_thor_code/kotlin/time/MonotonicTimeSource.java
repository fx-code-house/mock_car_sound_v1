...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2090boximpl(m2084markNowz9LOYto());
    }
    ...
    public long m2084markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2093constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2083elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2082differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2081adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2093constructorimpl(LongSaturatedMathKt.m2079saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
