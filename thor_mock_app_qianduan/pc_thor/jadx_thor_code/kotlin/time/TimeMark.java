...
public interface TimeMark {
    ...
    TimeMark mo1941minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1943plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2088plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2087minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1943plusLRDsOJo(Duration.m2003unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1983isNegativeimpl(timeMark.mo1940elapsedNowUwyO8pc());
        }
