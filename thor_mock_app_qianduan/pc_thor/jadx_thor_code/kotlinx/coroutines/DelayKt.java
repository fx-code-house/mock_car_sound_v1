...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2183scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2114delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2115toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2115toDelayMillisLRDsOJo(long j) {
        if (Duration.m1949compareToLRDsOJo(j, Duration.INSTANCE.m2053getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1968getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
