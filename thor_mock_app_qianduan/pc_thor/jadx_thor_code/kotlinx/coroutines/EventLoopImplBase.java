...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo2183scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
    ...
    public final void mo2182dispatch(CoroutineContext context, Runnable block) {
        enqueue(block);
    }
    ...
    private final boolean enqueueImpl(Runnable task) {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                if (iAddLast == 1) {
                    LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore2.next());
                } else if (iAddLast == 2) {
                    return false;
                }
            }
    ...
    private final int scheduleImpl(long now, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, (Object) null, new DelayedTaskQueue(now));
            Object obj = atomicReferenceFieldUpdater.get(this);
