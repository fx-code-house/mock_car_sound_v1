...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public void mo2194invokeOnClose(Function1<? super Throwable, Unit> handler) {
        this._channel.mo2194invokeOnClose(handler);
    }
    ...
    public Object mo2131receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2131receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2132tryReceivePtdJZtk() {
        return this._channel.mo2132tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2127trySendJP2dKIU(E element) {
        return this._channel.mo2127trySendJP2dKIU(element);
    }
