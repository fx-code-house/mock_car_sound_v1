...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM624constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM624constructorimpl = Result.m624constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM624constructorimpl = Result.m624constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m630isFailureimpl(objM624constructorimpl)) {
                objM624constructorimpl = null;
            }
            return (E) objM624constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM624constructorimpl = Result.m624constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM624constructorimpl = Result.m624constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m630isFailureimpl(objM624constructorimpl) ? null : objM624constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM624constructorimpl = Result.m624constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM624constructorimpl = Result.m624constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m630isFailureimpl(objM624constructorimpl)) {
            objM624constructorimpl = numValueOf;
        }
        return ((Number) objM624constructorimpl).intValue();
    }
