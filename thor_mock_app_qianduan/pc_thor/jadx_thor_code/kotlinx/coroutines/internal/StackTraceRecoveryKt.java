...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM624constructorimpl2;
        ...
        try {
            ...
            objM624constructorimpl = Result.m624constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM624constructorimpl = Result.m624constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m627exceptionOrNullimpl(objM624constructorimpl) == null) {
            obj2 = objM624constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM624constructorimpl2 = Result.m624constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM624constructorimpl2 = Result.m624constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m627exceptionOrNullimpl(objM624constructorimpl2) == null) {
            obj = objM624constructorimpl2;
        }
